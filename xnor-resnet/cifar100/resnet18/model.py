...
#{{{
    ...
    def forward(self, x):
        ...
        binary_weights = binary_weights_no_grad.detach() - cliped_weights.detach() + cliped_weights.detach()
...
def ResNet18_XNOR():
    return ResNet_XNOR(BasicBlock_XNOR, [2,2,2,2])

def ResNet34_XNOR():
    return ResNet_XNOR(BasicBlock_XNOR, [3,4,6,3])
