...
#{{{
    ...
    parser.add_argument('--arch', action='store', default='ResNet18_XNOR',
            help='the network structure: default ResNet18_XNOR')
...
#}}}
    ...
    if args.arch == 'ResNet18_XNOR':
      ...
      if ensemble == True:
        ...
        net.layer4[0].binaryconv1.weights.requires_grad = False
        net.layer4[0].binaryconv2.weights.requires_grad = False
        net.layer4[0].shortcut[0].weight.requires_grad = False #conv2d shortcut
        net.layer4[1].binaryconv1.weights.requires_grad = False
        net.layer4[1].binaryconv2.weights.requires_grad = False
    else:
